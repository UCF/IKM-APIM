...
<script type="text/javascript"> 
	...
	$(document).ready(function () {
		...
		var source =
		{
			...
			updata = updata + "&OSCEOLA=" + rowdata.OSCEOLA + "&METROWEST=" + rowdata.METROWEST + "&VALENCIA=" + rowdata.VALENCIA + "&VALSPS=" + rowdata.VALSPS + "&loadas=" + rowdata.loadas;
			updata = updata + "&main=" + rowdata.MAIN + "&nona=" + rowdata.NONA + "&rosen=" + rowdata.ROSEN + "&downtown=" + rowdata.DOWNTOWN + "&ncsara=" + rowdata.NCSARA;

			//set the url based on if it's regional or not
			var regions = ["ALTSPRNG","COCOA","DAYTONA","LEESBURG","OCALA","PALMBAY","LAKEMARY","SOUTHLAKE","OSCEOLA","METROWEST","VALENCIA","VALSPS"];
		...
		var cellbeginedit = function (row, datafield, columntype, value) {
			...
			var gradRestricted = ["Online","ASBS","loadas","loadasnames","ReAdmit","Mrkt. Rate Tuition","Cost Recovery","Online","OnlineBOG","NCSARA"];

			//stop ugrad college folks from editing certain fields
			var ugradRestricted = ["Online","Mrkt. Rate Tuition","Cost Recovery","PlanLongName","SubPlanLongName","Online","OnlineBOG","NCSARA"];
		...
		var addfilter = function () {			
			...
			if ($.inArray("Orientation",groups) != -1 || $.inArray("Regional",groups) != -1 || $.inArray("All",groups) != -1) { 
					...
					$("#mainData").jqxGrid('showcolumn','DOWNTOWN');
					...
					$("#mainData").jqxGrid('showcolumn','VALSPS');
		...
		$("#mainData").jqxGrid({
		    ...
		    columngroups: [
					{ text: '', align: 'center', name: 'General' },
                  	...
                  	{ text: 'UCF Connect Campuses', align: 'center', name: 'RegionalCampus' },
                  	{ text: 'Locations', align: 'center', name: 'OtherLocations' }
		    ],
		    ready: function () {			
			...
			{ text: 'College',   align: 'center', datafield: 'College', width: 60, editable: false, filterable: true, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, pinned: true, rendered: toolTip},
			{ text: 'Dept.', align: 'center', datafield: 'Dept.', width: 95, editable: false, filterable: true, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, pinned: true, rendered: toolTip},			
			{ text: 'CIP', align: 'center', datafield: 'CIP', width: 62, editable: false, filterable: false, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, pinned: true, rendered: toolTip},			
			...
			{ text: 'Term Start', align: 'center', datafield: 'TermStart', width: 99, editable: false, filterable: false, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer,pinned:true, rendered: toolTip},						
			{ text: 'Plan Name', align: 'center', datafield: 'PlanName', width: 195, editable: false, filterable: false, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer,pinned:true, rendered: toolTip},			
			{ text: 'Plan',  datafield: 'Plan', width: 93, editable: false, filterable: true, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, pinned:true, rendered: toolTip },
			{ text: 'SubPlan', datafield: 'Subplan', width: 93, editable: false, filterable: false, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, pinned:true, rendered: toolTip},
			{ text: 'Plan Type', datafield: 'Plan Type', width: 75, editable: false, filterable: false,cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, pinned:true, rendered: toolTip},
			
			{ text: 'Strat. Emphasis', columngroup: 'General', datafield: 'Stratemph', width: 97, filterable: true, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, rendered: toolTip },
			{ text: 'UCF Connect?', columngroup: 'General', datafield: 'Regional', align: 'center', width: 98, filterable: true,rendered: toolTip, editable: false},
			...
			{ text: 'Program', columngroup: 'General', datafield: 'ProgCode', width: 93, editable: false, filterable: true, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, rendered: toolTip },
			{ text: 'Degree', columngroup: 'General', datafield: 'Degree', renderer: info,  width: 70, filterable: false, editable: false, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, rendered: toolTip},
			{ text: 'Career', columngroup: 'General', datafield: 'Career', renderer: info,  width: 70, filterable: true, editable: false, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, rendered: toolTip},
			{ text: 'Level', columngroup: 'General', datafield: 'Level', renderer: info,  width: 70, filterable: false, editable: false, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, rendered: toolTip},			
			...
			{ text: 'Susp./Inact. Date', align: 'center', columngroup: 'General', datafield: 'StatusChange', width: 99, filterable: false, editable: false, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, rendered: toolTip},		
			{ text: 'Access', columngroup: 'General', datafield: 'Access', width: 80, filterable: false, editable: false, cellclassname: accessback, cellbeginedit: cellbeginedit,  cellsrenderer: cellsrenderer, rendered: toolTip},
			...
			{ text: 'Load As', columngroup: 'General',datafield: 'loadas', cellbeginedit: cellbeginedit, width: 160, columntype: "dropdownlist", filterable: false, rendered: toolTip,
			...
			{ text: 'NCSARA', columngroup: 'General', datafield: 'NCSARA', columntype: 'checkbox', width: 105,filterable: false, cellbeginedit: cellbeginedit, rendered: toolTip},
			...
			{ text: 'Downtown', columngroup: 'OtherLocations', datafield: 'DOWNTOWN', columntype: 'checkbox', hidden: false, width: 75,filterable: false, cellbeginedit: cellbeginedit, rendered: toolTip},
			...
			{ text: 'Valencia SPS', columngroup: 'RegionalCampus', datafield: 'VALSPS', columntype: 'checkbox', hidden: true, width: 75,filterable: false, cellbeginedit: regbeginedit, rendered: toolTip},
			...
			{ text: 'avail', datafield: 'avail', hidden: true, filterable: false, cellbeginedit: cellbeginedit}	
		    ]
		}); 
